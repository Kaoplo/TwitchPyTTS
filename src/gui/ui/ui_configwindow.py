...
class Ui_ConfigWindow(object):
    ...
    def retranslateUi(self, ConfigWindow):
        ConfigWindow.setWindowTitle(
            QCoreApplication.translate("ConfigWindow", "Configure", None)
        )
        self.ChannelText.setText(
            QCoreApplication.translate("ConfigWindow", "Channel", None)
        )
        self.pronounciationText.setText(
            QCoreApplication.translate(
                "ConfigWindow", "Pronounciation (use {username} and {message})", None
            )
        )
        self.IgnorelistText.setText(
            QCoreApplication.translate(
                "ConfigWindow", "Ignorelist (comma separated usernames)", None
            )
        )
        self.voiceModelText.setText(
            QCoreApplication.translate(
                "ConfigWindow", "Voice model (Piper voice name)", None
            )
        )
        self.skipCommandText.setText(
            QCoreApplication.translate(
                "ConfigWindow", "Mod skip command (without the ! prefix)", None
            )
        )
        self.modOnlySkip.setText(
            QCoreApplication.translate(
                "ConfigWindow",
                "Only allow moderators/broadcaster to use the skip command",
                None,
            )
        )
        self.closeButton.setText(
            QCoreApplication.translate("ConfigWindow", "Done", None)
        )
        self.cancelButton.setText(
            QCoreApplication.translate("ConfigWindow", "Cancel", None)
        )
